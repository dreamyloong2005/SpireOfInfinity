...
public static class StringExtensions
{
    ...
    {
        return Path.Join(MainFile.ModId, "images", "packed", "card_portraits", path);
    }
    public static string BigCardImagePath(this string path)
    {
        return Path.Join(MainFile.ModId, "images", "packed", "card_portraits", "big", path);
    }
    ...
    public static string CharacterSelectPath(this string path)
    {
        return Path.Join(MainFile.ModId, "images", "packed", "character_select", path);
    }
}